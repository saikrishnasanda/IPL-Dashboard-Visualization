...
def all_overall(df_mat, df_bb):
    ...
    sns_obj_batter_sig_mat = sns.barplot(x='batsman_run', y='batter', data=top10_batter_sig_mat, ax=axis_batter_sig_mat, estimator=np.max, ci=None)
    ...
    sns_obj_high_score_team = sns.barplot(x='total_run', y='BattingTeam', data=top10_high_score_team, ax=axis_high_score_team, estimator=np.max, ci=None)
        
    sns_obj_high_score_team.bar_label(sns_obj_high_score_team.containers[0])
        
    axis_high_score_team.set_title('Top 5 Teams whose Score High In IPL History')
    ...
    sns_obj_low_score_team = sns.barplot(x='total_run', y='BattingTeam', data=top10_low_score_team, ax=axis_low_score_team, estimator=np.max, ci=None)
    sns_obj_low_score_team.bar_label(sns_obj_low_score_team.containers[0])
    axis_low_score_team.set_title('Top 5 Teams Whose Score Low In IPL History')
